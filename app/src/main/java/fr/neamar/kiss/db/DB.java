...
class DB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        database.execSQL("CREATE TABLE notes ( _id INTEGER PRIMARY KEY AUTOINCREMENT, type TEXT NOT NULL, parentId TEXT, childIds TEXT, content TEXT NOT NULL, contentReply TEXT, timestamp INTEGER NOT NULL, tags TEXT NOT NULL)");
        createTags(database);
